        ...
        <div className="w-10/12 h-5/6 gap-4 justify-center bg-white rounded-lg model relative container px-4 flex items-center">
          ...
          <div className="flex-1 flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2 flex-col md:flex-row">
              <input type="number" name="" min={1}  id="" className="border-2 border-black py-2 pl-2 focus:outline-none" />
              <div className="flex bg-green-500 text-white px-4 py-2 rounded-lg cursor-pointer items-center gap-2 ">
